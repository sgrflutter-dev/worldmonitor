...
const BASE_URL = typeof window !== 'undefined' ? window.location.origin : 'https://worldmonitor.app';
const DEFAULT_IMAGE = `${typeof window !== 'undefined' ? window.location.origin : 'https://worldmonitor.app'}/favico/og-image.png`;
